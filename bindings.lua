...
vim.keymap.set('n', vinote_leader_key .. create_table_key, function() visual.create_table() end)
vim.keymap.set('n', vinote_leader_key .. update_table_key, function() visual.update_table() end)
